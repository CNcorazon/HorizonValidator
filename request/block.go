...
func RequestTransaction(shardNum uint, url string, route string, id string) model.BlockPackedTransactionResponse {
	URL := url + route
	...
	var res model.BlockPackedTransactionResponse
	json.Unmarshal(body, &res)
	return res
}
